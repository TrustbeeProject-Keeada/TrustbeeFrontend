  ...
  if (!user) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-20 text-center">
        ...
        <p className="mt-2 text-muted-foreground">You need to be logged in as an employer to manage jobs.</p>
      ...
      <ScrollReveal>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-muted-foreground">Manage your posted jobs — edit, delete, or create new ones.</p>
          </div>
          <Link to="/create-job">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will permanently remove "{job.title}" from your listings.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
