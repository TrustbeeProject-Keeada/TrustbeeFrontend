              ...
              <>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input type="number" placeholder="5566778899" value={organizationNumber} onChange={(e) => setOrganizationNumber(e.target.value)} />
                  </div>
                  <div className="space-y-2">
                    <Label>Phone number *</Label>
                    <Input type="tel" placeholder="+46 70 123 4567" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label>Company description</Label>
                  <Input placeholder="Brief description of your company" value={description} onChange={(e) => setDescription(e.target.value)} />
                </div>
              </>
            )}
